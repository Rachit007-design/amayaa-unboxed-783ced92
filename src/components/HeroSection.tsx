...
const HeroSection = () => {
  return <section className="relative min-h-screen flex items-center justify-center pt-24 pb-20 grain-overlay overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-16">
          ...
          <div className="flex flex-col items-center text-center max-w-2xl px-4">
            ...
            ease: [0.23, 1, 0.32, 1]
              ...
              AI-Driven Content
              <br />
              <span className="text-muted-foreground">That Scales Brands</span>
            </motion.h1>
            ...
            delay: 0.4
              ...
              <motion.a href="#showcase" whileHover={{
              scale: 1.02
            }} whileTap={{
              scale: 0.98
            }} className="btn-pill">
              ...
              <motion.a href="#pricing" whileHover={{
              scale: 1.02
            }} whileTap={{
              scale: 0.98
          ...
          {/* Right Video Frame - Shows different video on mobile */}
